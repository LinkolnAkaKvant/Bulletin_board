"""
Django settings for my_skymarket_CW6 project.
...
SECRET_KEY = 'django-insecure-ho!moj4!oam5w)2(kfg+*q_lypw#gmv2dj$+^buhi!zv#7e9$&'
...
ROOT_URLCONF = 'my_skymarket_CW6.urls'
...
WSGI_APPLICATION = 'my_skymarket_CW6.wsgi.application'
